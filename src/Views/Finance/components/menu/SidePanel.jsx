    ...
    <div className="fixed xcol-span-1 row-span-5 bg-whitex sidepanel z-10 shadow-lg xfixed">
      <div>
        ...
        <div className="text-left">
          ...
          <Link to="/finance/bids" className={active_selectr.bids}>
            <BidIconSvg classx="inline w-5 mr-3 stroke-current" />
            Bids
          </Link>
          
          <Link to="/finance/projects" className={active_selectr.projects}>
            <FolderOpenSvg classx="inline w-5 mr-3 stroke-current" />
            Projects
          </Link>
          
          <Link to="/finance/companies" className={active_selectr.companies}>
            <CompaniesIcon classx="inline w-5 mr-3 stroke-current" />
            Companies
          </Link>
          <Link to="/finance/tasks" className={active_selectr.tasks}>
            <TasksIcon classx="inline w-5 mr-3 stroke-current" />
            Tasks
          </Link>
          <Link to="/finance/consumables" className={active_selectr.equipments}>
...
{/* 
          ...
          <Link to="/finance/expenses" className={active_selectr.expenses}>
        ...
        <div className="mt-10 absolutebottom-3 ">
          <Link to="/finance/settings" className={active_selectr.settings}>
