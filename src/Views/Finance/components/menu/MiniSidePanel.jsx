...
export default function MiniSidePanel({ active_selectr, updateUser }) {
  ...
  <div className="fixed xcol-span-1 row-span-5 bg-whitex mini-sidepanel z-10 shadow-lg xfixed hidden sm:block">
        ...
        <div className="text-left">
          ...
          <Link to="/finance/bids" className={active_selectr.bids}><BidIconSvg classx='inline w-5 mr-3 stroke-current'/></Link>
          <Link to="/finance/projects" className={active_selectr.projects}><FolderOpenSvg classx='inline w-5 mr-3 stroke-current'/></Link>
          <Link to="/finance/companies" className={active_selectr.companies}><CompaniesIcon classx='inline w-5 mr-3 stroke-current'/></Link>
          <Link to="/finance/tasks" className={active_selectr.tasks}><TasksIcon classx='inline w-5 mr-3 stroke-current'/></Link>
          <Link to="/finance/consumables" className={active_selectr.equipments}><EquipmentsIcon classx='inline w-5 mr-3 stroke-current'/></Link>
          ...
          <Link to="/finance/expenses" className={active_selectr.expenses}><ExpensesIcon classx='inline w-5 mr-3 stroke-current'/></Link>
        ...
        <div className='xmt-8 absolute bottom-3 '>
          <Link to="/finance/settings" className={active_selectr.settings}><SettingsIcon classx='inline w-5 mr-3 stroke-current'/></Link>
