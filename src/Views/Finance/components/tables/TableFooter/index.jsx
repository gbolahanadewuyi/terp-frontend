  ...
  return (
    <div className={styles.tableFooter_cus}>
      ...
      <div className={styles.nav_container}>
        <div className={styles.button_cus}><button onClick={() => flipPrev()}><ArrowleftIcon classx='stroke-current md:w-full w-6'/></button>Prev</div>
        <div className={styles.button}>{page} of {range.length}</div>
        {/* <div className={styles.temp_spacer}></div> */}
        <div className={styles.button_cus}>Next<button onClick={() => flipNext()}><ArrowRightIcon classx='stroke-current md:w-full w-6'/></button></div>
