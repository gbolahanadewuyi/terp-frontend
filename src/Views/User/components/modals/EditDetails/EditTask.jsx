    ...
    <div className={props.show}>
        <div className="xback-board txt-dark-bluex">
            <div className="modal-inner-edit-x">
                ...
                <form className="grid grid-cols-6 gap-4 px-10 py-6">
                    ...
                    <div className="col-span-6 text-left">
                        <label className='text-blue-900' htmlFor="scope">Task Scope</label><br></br>
                        <textarea type="text" className="shadow appearance-none border rounded w-full py-2 px-3 mt-2 focus:outline-none focus:shadow-outline bg-gray-200" placeholder="Enter Task Scope" id='scope' name='scope'></textarea>
                    </div>
                    ...
                    <div className="col-span-6 grid grid-cols-8 gap-4">
                        <div className="col-span-8 md:col-span-2 text-left">
                    ...
                    <input type="submit" className="md:col-start-5 col-start-4 md:col-span-2 col-span-3 shadow appearance-none border rounded w-full py-2 px-3 text-white button-solidx mt-2 focus:outline-none focus:shadow-outline" id='submit-button' value='Save Changes'/>
                </form>
            </div>
        </div>
    </div>
