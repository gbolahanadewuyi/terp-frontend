                    ...
                    return(
                        <div className=' bg-whitex rounded txt-darkblue2 shadow-lg' key={e?.id}>
                            <div className='p-3'>
                               ...
                               {/* <div> <span className='ml-auto '>Company:{" " + e?.winning_company}</span></div> */}

                                {/* <div className='flex'><span>{e?.client}</span> <span className='ml-auto xwhitespace-nowrap'>{e?.winning_company}</span></div> */}
                            </div>
