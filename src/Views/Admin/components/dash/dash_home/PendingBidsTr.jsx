                    ...
                    <div className="shadow overflow-hidden border-b border-gray-200 xsm:rounded-lg">
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-whitex divide-y divide-gray-200">
                                ...
                                var status_style;
                                if(e.status === 'Won'){status_style = 'px-2 py-1 text-xs text-center rounded xpass capitalize'}
                                else if(e.status === 'Lost'){status_style = 'px-2 py-1 text-xs text-center rounded xfail capitalize'}
                                ...
                                <tr key={e.id}>
                                    ...
                                    <td className="px-6 py-4 xwhitespace-nowrap text-sm capitalize">{e.winning_company}</td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm ">{naira_sign}{e.contractSum}</td>
