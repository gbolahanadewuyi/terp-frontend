    ...
    <>
      ...
      <div className="headr bg-whitex flex lg:pr-4">
        ...
        <div className='txt-dark-bluex-v2 ml-auto mr-3 my-auto flex h-full align-middle py-4'>
          ...
          {/* <span className="pr-10 relative top-1 hidden md:block"><DarkmodeToggle/></span> */}
          <span className='inline-flex relative'>
            <span className='pr-2 pl-10 cborder md:border-l-2'>
              {name}
            </span>
            <span className="w-8 h-8 bg-cover rounded-md mr-0">
              <img src={photo} alt='' className="h-full w-full overflow-hidden object-cover rounded-full border-2 border-white" />
            </span>
            <div className={`my-auto ml-2 hover:bg-gray-300 px-1 md:hidden block ${dropdown_activated}`} onClick={toggleDropdown}>
