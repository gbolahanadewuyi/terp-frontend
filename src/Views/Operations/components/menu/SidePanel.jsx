    ...
    <div className="fixed xcol-span-1 row-span-5 bg-whitex sidepanel z-10 shadow-lg xfixed">
      <div>
        ...
        <div className="text-left">
          ...
          <Link to="/operations/bids" className={active_selectr.bids}>
            <BidIconSvg classx="inline w-5 mr-3 stroke-current" />
            Bids
          </Link>
          <Link to="/operations/projects" className={active_selectr.projects}>
            <FolderOpenSvg classx="inline w-5 mr-3 stroke-current" />
            Projects
          </Link>
          
          <Link to="/operations/companies" className={active_selectr.companies}>
            <CompaniesIcon classx="inline w-5 mr-3 stroke-current" />
            Companies
          </Link>
          <Link to="/operations/tasks" className={active_selectr.tasks}>
            <TasksIcon classx="inline w-5 mr-3 stroke-current" />
            Tasks
          </Link>
          <Link to="/operations/consumables" className={active_selectr.equipments}>
        ...
        <div className="mt-10 absolutebottom-3 ">
          <Link to="/operations/settings" className={active_selectr.settings}>
